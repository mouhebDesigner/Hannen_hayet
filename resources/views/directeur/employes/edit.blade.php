            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ url('chef/employes/'.$employe->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="card-body" id="inputs">
                                <div class="form-group">
                                    <label for="name">Nom d'employe</label>
                                    <input type="text" class="form-control" name="name" value="{{ $employe->name }}" id="name" placeholder="Saisir name d'employe">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email" value="{{ $employe->email }}" id="email" placeholder="Saisir email d'employe">
                                    @error('email')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password"  id="password" placeholder="Saisir password d'employe">
                                    @error('password')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password_confirmation"  id="password" placeholder="Saisir password d'employe">
                                    @error('password')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="numtel" value="{{ $employe->numtel }}" id="numtel" placeholder="Saisir numtel d'employe">
                                    @error('numtel')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
