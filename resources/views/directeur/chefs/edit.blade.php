                        ...
                        <form action="{{ url('directeur/chefs/'.$chef->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body" id="inputs">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $chef->name }}" id="name" placeholder="Saisir name de matiére">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email" value="{{ $chef->email }}" id="email" placeholder="Saisir email de matiére">
                                    @error('email')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="numtel" value="{{ $chef->numtel }}" id="numtel" placeholder="Saisir numtel de matiére">
                                    @error('numtel')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
