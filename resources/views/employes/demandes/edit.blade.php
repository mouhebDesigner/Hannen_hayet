            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ url('employe/demandes/'.$demande->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="materiel_id" id="materiel_id" class="form-control">
                                        ...
                                        @foreach(App\Models\Materiel::where('categorie', $demande->materiel->categorie)->get(['id', 'nom']) as $materiel)
                                            <option value="{{ $materiel->id }}" @if($demande->materiel->id == $materiel->id) selected @endif>{{ $materiel->nom }}</option>
                                        @endforeach
                                    </select>
                                    @error('materiel_id')
